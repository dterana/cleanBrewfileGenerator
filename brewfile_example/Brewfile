...
brew "fontconfig" # XML-based font configuration API for X Windows
...
brew "shopify/shopify/shopify-cli" # A CLI tool to build for the Shopify platform
...
cask "asana" # Manage team projects and tasks
...
cask "huggingchat" # Chat client for models on HuggingFace
cask "karabiner-elements" # Keyboard customiser
cask "lm-studio" # Discover, download, and run local LLMs
cask "localsend" # Open-source cross-platform alternative to AirDrop
